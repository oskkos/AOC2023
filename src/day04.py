"""Advent of Code 2023 - Day 4 tasks"""
...
def part_one(lines: list[str]) -> int:
    ...
    new landmass suddenly appears above you! The gondola carries you to the surface of the
...
def part_two(lines: list[str]) -> int:
    ...
    * Your one instance of card 6 (one original) has no matching numbers and wins no more cards.
    ...
    card 1, 2 instances of card 2, 4 instances of card 3, 8 instances of card 4, 14 instances of
...
def add_cards(cards: dict[int, int], subsequent_cards: list[int]) -> None:
    ...
    Args:
        ...
        subsequent_cards (list): The subsequent cards to be added.

    Returns:
        None
    """
    for match in subsequent_cards:
...
def add_card(cards: dict[int, int], card_nbr: int) -> None:
    ...
    If the card number is already present in the dictionary, increment its count by 1.
    If the card number is not present, add it to the dictionary with a count of 1.

    Args:
        cards (dict): The dictionary of card numbers and their counts.
        card_nbr (int): The card number to be added.

    Returns:
        None
    """
    if card_nbr not in cards:
        cards[card_nbr] = 1
    else:
        cards[card_nbr] += 1
