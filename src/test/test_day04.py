"""Advent of Code 2023 - Unit tests for day 4 tasks"""
from .. import util
...
def test_part_one():
    ...
    assert part_one(example_data) == 13
...
def test_part_two():
    ...
    assert part_two(example_data) == 30
    assert part_two(util.get_lines("day04")) == 6874754
